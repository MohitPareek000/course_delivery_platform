...
// CSV file path
const CSV_FILE_PATH = path.join(process.cwd(), 'CourseAccess/learnerDSA.csv');
...
async function addDSAMembers() {
  console.log('=== ADDING DSA COURSE MEMBERS ===\n');
...
async function main() {
  try {
    ...
    if (!fs.existsSync(CSV_FILE_PATH)) {
      ...
      console.log('john@example.com,John Doe,cmjjnrppn0000sglhhbeomp2a');
      process.exit(1);
    }
